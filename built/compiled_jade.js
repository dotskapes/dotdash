...
jade.templates['table'] = function anonymous(locals, attrs, escape, rethrow, merge) {
attrs = attrs || jade.attrs; escape = escape || jade.escape; rethrow = rethrow || jade.rethrow; merge = merge || jade.merge;
var __jade = [{ lineno: 1, filename: undefined }];
try {
var buf = [];
...
// iterate features
;(function(){
  if ('number' == typeof features.length) {
...
__jade.unshift({ lineno: 6, filename: __jade[0].filename });
buf.push('<tr');
buf.push(attrs({ 'fid':(feature.id) }, {"fid":true}));
buf.push('>');
__jade.unshift({ lineno: undefined, filename: __jade[0].filename });
__jade.unshift({ lineno: 7, filename: __jade[0].filename });
// iterate columns 
...
__jade.unshift({ lineno: 8, filename: __jade[0].filename });
buf.push('<td>');
var __val__ = feature.attr(column)
buf.push(escape(null == __val__ ? "" : __val__));
__jade.unshift({ lineno: undefined, filename: __jade[0].filename });
__jade.shift();
buf.push('</td>');
