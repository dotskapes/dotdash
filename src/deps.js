...
// Please do not edit.
goog.addDependency('../src/Dashboard.js', ['Dashboard'], ['AggregateModel', 'BasicTimePanel', 'DashboardState', 'Filter', 'GridPanel', 'MapPanel', 'MoveSelModel', 'Panel', 'PanelManager', 'PanelState', 'ScatterPanel', 'SelectionManager', 'ServiceLayer', 'SidebarController', 'TablePanel', 'TimePanel', 'TimeSliderController', 'WordCloudPanel', 'dash']);
...
goog.addDependency('../src/controllers/panel_manager.js', ['PanelManager'], ['GridPanel', 'MapPanel', 'TablePanel', 'TimePanel']);
goog.addDependency('../src/controllers/panels/BasicTimePanel.js', ['BasicTimePanel'], ['Panel']);
goog.addDependency('../src/controllers/panels/GridPanel.js', ['GridPanel'], ['ColorMap', 'Panel']);
goog.addDependency('../src/controllers/panels/MapPanel.js', ['MapPanel'], ['ColorMap', 'Panel']);
goog.addDependency('../src/controllers/panels/ScatterPanel.js', ['ScatterPanel'], ['Panel']);
...
goog.addDependency('../src/controllers/panels/WordCloudPanel.js', ['WordCloudPanel'], ['Panel']);
