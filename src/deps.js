...
goog.addDependency('../src/controllers/FilterController.js', ['filterController'], []);
goog.addDependency('../src/controllers/SidebarController.js', ['sidebarController'], ['colorController', 'filterController']);
...
goog.addDependency('../src/controllers/panel_manager.js', ['panelManager'], ['MDSPanel', 'MapPanel', 'ServiceLayer', 'TimePanel', 'dashState', 'filter', 'panelState', 'selectionManager']);
...
goog.addDependency('../src/dash.js', ['dash'], ['ServiceLayer', 'dashState', 'panelManager', 'sidebarController', 'timeSlider']);
